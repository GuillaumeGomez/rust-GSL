...
fn func(t: f64, t_y: *const f64, t_f: *mut f64, params: *mut c_void) -> rgsl::enums::Value {
    unsafe {
...
#[allow(unused_variable)]
fn jac(t: f64, t_y: *const f64, t_dfdy: *mut f64, t_dfdt: *mut f64, params: *mut c_void) -> rgsl::enums::Value {
    unsafe {
        let mu : &mut f64 = ::std::mem::transmute(params);
