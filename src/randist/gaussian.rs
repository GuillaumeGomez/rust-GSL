...
pub fn gaussian(r: &mut Rng, sigma: f64) -> f64 {
    unsafe { sys::gsl_ran_gaussian(ffi::FFI::unwrap_unique(r), sigma) }
}
...
pub fn gaussian_ziggurat(r: &mut Rng, sigma: f64) -> f64 {
    unsafe { sys::gsl_ran_gaussian_ziggurat(ffi::FFI::unwrap_unique(r), sigma) }
}
...
pub fn gaussian_ratio_method(r: &mut Rng, sigma: f64) -> f64 {
    unsafe { sys::gsl_ran_gaussian_ratio_method(ffi::FFI::unwrap_unique(r), sigma) }
}
...
pub fn ugaussian(r: &mut Rng) -> f64 {
    unsafe { sys::gsl_ran_ugaussian(ffi::FFI::unwrap_unique(r)) }
}
...
pub fn ugaussian_ratio_method(r: &mut Rng) -> f64 {
    unsafe { sys::gsl_ran_ugaussian_ratio_method(ffi::FFI::unwrap_unique(r)) }
}
