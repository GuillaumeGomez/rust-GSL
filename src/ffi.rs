...
extern "C" {
    ...
    pub fn gsl_bspline_knots(breakpts: *const gsl_vector, w: *mut gsl_bspline_workspace) -> enums::Value;
    ...
    pub fn gsl_ran_bivariate_gaussian(r: *mut gsl_rng, sigma_x: c_double, sigma_y: c_double, rho: c_double, x: *mut c_double,
        y: *mut c_double);
    ...
    pub fn gsl_ran_levy_skew(r: *mut gsl_rng, c: c_double, alpha: c_double, beta: c_double) -> c_double;
    ...
    pub fn gsl_ran_dirichlet(r: *mut gsl_rng, K: size_t, alpha: *const c_double, theta: *mut c_double);
    ...
    pub fn gsl_ran_multinomial(r: *mut gsl_rng, K: size_t, N: c_uint, p: *const c_double, n: *mut c_uint);
    ...
    pub fn gsl_ran_choose(r: *mut gsl_rng, dest: *mut c_void, k: size_t, src: *mut c_void, n: size_t, size: size_t) -> enums::Value;
    pub fn gsl_ran_sample(r: *mut gsl_rng, dest: *mut c_void, k: size_t, src: *mut c_void, n: size_t, size: size_t) -> enums::Value;
