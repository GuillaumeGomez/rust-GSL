...
pub fn Ai_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    ...
    let ret = unsafe { sys::gsl_sf_airy_Ai_e(x, mode.into(), &mut result) };
...
pub fn Bi_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Bi_e(x, mode.into(), &mut result) };
...
pub fn Ai_scaled_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Ai_scaled_e(x, mode.into(), &mut result) };
...
pub fn Bi_scaled_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Bi_scaled_e(x, mode.into(), &mut result) };
...
pub fn Ai_deriv_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Ai_deriv_e(x, mode.into(), &mut result) };
...
pub fn Bi_deriv_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Bi_deriv_e(x, mode.into(), &mut result) };
...
pub fn Ai_deriv_scaled_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Ai_deriv_scaled_e(x, mode.into(), &mut result) };
...
pub fn Bi_deriv_scaled_e(x: f64, mode: ::Mode) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_Bi_deriv_scaled_e(x, mode.into(), &mut result) };
...
pub fn zero_Ai_e(s: u32) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_zero_Ai_e(s, &mut result) };
...
pub fn zero_Bi_e(s: u32) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_zero_Bi_e(s, &mut result) };
...
pub fn zero_Ai_deriv_e(s: u32) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_zero_Ai_deriv_e(s, &mut result) };
...
pub fn zero_Bi_deriv_e(s: u32) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<sys::gsl_sf_result>() };
    let ret = unsafe { sys::gsl_sf_airy_zero_Bi_deriv_e(s, &mut result) };
