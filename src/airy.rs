...
pub fn Ai_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
...
pub fn Bi_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Ai_scaled_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Bi_scaled_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Ai_deriv_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Bi_deriv_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Ai_deriv_scaled_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
...
pub fn Bi_deriv_scaled_e(x: f64, mode: ::Mode) -> Result<types::Result, Value> {
    let mut result = MaybeUninit::<sys::gsl_sf_result>::uninit();
