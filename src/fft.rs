...
pub mod mixed_radix {
    ...
    pub fn forward(data: &mut [f64], stride: u64, n: u64, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::Value {
    ...
    pub fn transform(data: &mut [f64], stride: u64, n: u64, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace, sign: enums::FftDirection) -> enums::Value {
    ...
    pub fn backward(data: &mut [f64], stride: u64, n: u64, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::Value {
    ...
    pub fn inverse(data: &mut [f64], stride: u64, n: u64, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::Value {
...
pub mod real_radix2 {
    ...
    ///   }
    /// ```
    pub fn unpack(halfcomplex_coefficient: &mut [f64], complex_coefficient: &mut [f64], stride: u64, n: u64) -> enums::Value {
