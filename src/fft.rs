...
pub mod radix2 {
    ...
    pub fn forward(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_forward(data.as_mut_ptr(), stride, n) }
    }

    pub fn transform(data: &mut[f64], stride: usize, n: usize, sign: ::FftDirection) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_transform(data.as_mut_ptr(), stride, n, sign) }
    }

    pub fn backward(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_backward(data.as_mut_ptr(), stride, n) }
    }

    pub fn inverse(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
    ...
    pub fn dif_forward(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_dif_forward(data.as_mut_ptr(), stride, n) }
    }

    /// This is decimation-in-frequency version of the radix-2 FFT function.
    pub fn dif_transform(data: &mut[f64], stride: usize, n: usize, sign: ::FftDirection) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_dif_transform(data.as_mut_ptr(), stride, n, sign) }
    }

    /// This is decimation-in-frequency version of the radix-2 FFT function.
    pub fn dif_backward(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_radix2_dif_backward(data.as_mut_ptr(), stride, n) }
    }

    /// This is decimation-in-frequency version of the radix-2 FFT function.
    pub fn dif_inverse(data: &mut[f64], stride: usize, n: usize) -> enums::value::Value {
...
pub mod mixed_radix {
    ...
    pub fn forward(data: &mut [f64], stride: usize, n: usize, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_forward(data.as_mut_ptr(), stride, n, ffi::FFI::unwrap(wavetable),
            ffi::FFI::unwrap(work)) }
    }

    pub fn transform(data: &mut [f64], stride: usize, n: usize, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace, sign: ::FftDirection) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_transform(data.as_mut_ptr(), stride, n, ffi::FFI::unwrap(wavetable),
            ffi::FFI::unwrap(work), sign) }
    }

    pub fn backward(data: &mut [f64], stride: usize, n: usize, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::value::Value {
        unsafe { ffi::gsl_fft_complex_backward(data.as_mut_ptr(), stride, n, ffi::FFI::unwrap(wavetable),
            ffi::FFI::unwrap(work)) }
    }

    pub fn inverse(data: &mut [f64], stride: usize, n: usize, wavetable: &FftComplexWaveTable, work: &FftComplexWorkspace) -> enums::value::Value {
...
pub mod real_radix2 {
    ...
    /// below.
    pub fn transform(data: &mut [f64], stride: usize, n: usize) -> enums::value::Value {
    ...
    ///   }
    /// ```
    pub fn unpack(halfcomplex_coefficient: &mut [f64], complex_coefficient: &mut [f64], stride: usize, n: usize) -> enums::value::Value {
