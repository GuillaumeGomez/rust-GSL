...
pub mod polynomials {
    ...
    pub fn legendre_Pl_deriv_array(
        ...
        enums::Value::from(unsafe {
            ffi::gsl_sf_legendre_Pl_deriv_array(
...
pub mod associated_polynomials {
    ...
    pub fn legendre_Plm_deriv_array(
        ...
        enums::Value::from(unsafe {
            ffi::gsl_sf_legendre_Plm_deriv_array(
                result_array.len() as i32,
                m,
                x,
                result_array.as_mut_ptr(),
    ...
    pub fn legendre_sphPlm_array(m: i32, x: f64, result_array: &mut [f64]) -> enums::Value {
        enums::Value::from(unsafe {
            ffi::gsl_sf_legendre_sphPlm_array(
                result_array.len() as i32,
                m,
                x,
                result_array.as_mut_ptr(),
    ...
    pub fn legendre_sphPlm_deriv_array(
        ...
        enums::Value::from(unsafe {
            ffi::gsl_sf_legendre_sphPlm_deriv_array(
                result_array.len() as i32,
                m,
                x,
                result_array.as_mut_ptr(),
    ...
    pub fn legendre_deriv_array(
        ...
        enums::Value::from(unsafe {
            ffi::gsl_sf_legendre_deriv_array(
                norm.into(),
                lmax,
                x,
                result.as_mut_ptr(),
