...
pub mod Fit {
    ...
    pub fn linear(x: &[f64], xstride: u64, y: &[f64], ystride: u64, n: u64, c0: &mut f64, c1: &mut f64, cov00: &mut f64,
        cov01: &mut f64, cov11: &mut f64, sumsq: f64) -> i32 {
    ...
    pub fn wlinear(x: &[f64], xstride: u64, w: &[f64], wstride: u64, y: &[f64], ystride: u64, n: u64, c0: &mut f64, c1: &mut f64,
        cov00: &mut f64, cov01: &mut f64, cov11: &mut f64, chisq: &mut f64) -> i32 {
    ...
    pub fn linear_est(x: f64, c0: f64, c1: f64, cov00: f64, cov01: f64, cov11: f64, y: &mut f64, y_err: &mut f64) -> i32 {
    ...
    pub fn mul(x: &[f64], xstride: u64, y: &[f64], ystride: u64, n: u64, c1: &mut f64, cov11: &mut f64, sumsq: &mut f64) -> i32 {
    ...
    /// The weighted sum of squares of the residuals from the best-fit line, \chi^2, is returned in chisq.
    pub fn wmul(x: &[f64], xstride: u64, w: &[f64], wstride: u64, y: &[f64], ystride: u64, n: u64, c1: &mut f64, cov11: &mut f64, sumsq: &mut f64) -> i32 {
    ...
    pub fn mul_est(x: f64, c1: f64, cov11: f64, y: &mut f64, y_err: &mut f64) -> i32 {
