...
extern "C" {
    ...
    pub fn cblas_sdsdot(N: c_int,
                        ...
                        incy: c_int)
                        -> c_float;
    pub fn cblas_dsdot(N: c_int,
                       x: *const c_float,
                       incx: c_int,
                       y: *const c_float,
                       incy: c_int)
                       -> c_double;
    pub fn cblas_sdot(N: c_int,
                      x: *const c_float,
                      incx: c_int,
                      y: *const c_float,
                      incy: c_int)
                      -> c_float;
    pub fn cblas_ddot(N: c_int,
                      x: *const c_float,
                      incx: c_int,
                      y: *const c_float,
                      incy: c_int)
                      -> c_double;
    pub fn cblas_cdotu_sub(N: c_int,
                           x: *const c_void,
                           incx: c_int,
                           y: *const c_void,
                           incy: c_int,
                           dotu: *mut c_void);
    pub fn cblas_cdotc_sub(N: c_int,
                           x: *const c_void,
                           incx: c_int,
                           y: *const c_void,
                           incy: c_int,
                           dotc: *mut c_void);
    pub fn cblas_zdotu_sub(N: c_int,
                           x: *const c_void,
                           incx: c_int,
                           y: *const c_void,
                           incy: c_int,
                           dotu: *mut c_void);
    pub fn cblas_zdotc_sub(N: c_int,
                           x: *const c_void,
                           incx: c_int,
                           y: *const c_void,
                           incy: c_int,
    ...
    pub fn cblas_srotmg(d1: *mut c_float,
                        d2: *mut c_float,
                        b1: *mut c_float,
                        b2: *const c_float,
                        P: *mut c_float);
    pub fn cblas_srot(N: c_int,
                      x: *mut c_float,
                      incx: c_int,
                      y: *mut c_float,
                      incy: c_int,
    ...
    pub fn cblas_drotmg(d1: *mut c_double,
                        d2: *mut c_double,
                        b1: *mut c_double,
                        b2: *const c_double,
                        P: *mut c_double);
    pub fn cblas_drot(N: c_int,
                      x: *mut c_double,
                      incx: c_int,
                      y: *mut c_double,
                      incy: c_int,
    ...
    pub fn cblas_sgemv(order: cblas::Order,
                       ...
                       y: *mut c_float,
                       incy: c_int);
    pub fn cblas_sgbmv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       KL: c_int,
                       ...
                       y: *mut c_float,
                       incy: c_int);
    pub fn cblas_strmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_stbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_stpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_strsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_stbsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_stpsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_float,
                       incx: c_int);
    pub fn cblas_dgemv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       alpha: c_double,
                       ...
                       y: *mut c_double,
                       incy: c_int);
    pub fn cblas_dgbmv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       KL: c_int,
                       ...
                       y: *mut c_double,
                       incy: c_int);
    pub fn cblas_dtrmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_dtbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_dtpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_dtrsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_dtbsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_dtpsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_double,
                       incx: c_int);
    pub fn cblas_cgemv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_cgbmv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       KL: c_int,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_ctrmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ctbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ctpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ctrsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ctbsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ctpsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_zgemv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zgbmv(order: cblas::Order,
                       transA: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       KL: c_int,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_ztrmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ztbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ztpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ztrsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ztbsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ztpsv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       N: c_int,
                       ...
                       x: *mut c_void,
                       incx: c_int);
    pub fn cblas_ssymv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_float,
                       A: *const c_float,
                       ...
                       y: *mut c_float,
                       incy: c_int);
    pub fn cblas_ssbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: c_float,
                       ...
                       y: *mut c_float,
                       incy: c_int);
    pub fn cblas_sspmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_float,
                       Ap: *const c_float,
                       ...
                       y: *mut c_float,
                       incy: c_int);
    pub fn cblas_sger(order: cblas::Order,
                      M: c_int,
                      N: c_int,
                      alpha: c_float,
                      x: *const c_float,
                      ...
                      A: *mut c_float,
                      lda: c_int);
    pub fn cblas_ssyr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: c_float,
                      x: *const c_float,
                      ...
                      A: *mut c_float,
                      lda: c_int);
    pub fn cblas_sspr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: c_float,
                      x: *const c_float,
                      incx: c_int,
                      Ap: *mut c_float);
    pub fn cblas_ssyr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_float,
                       x: *const c_float,
                       ...
                       A: *mut c_float,
                       lda: c_int);
    pub fn cblas_sspr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_float,
                       x: *const c_float,
                       ...
                       incy: c_int,
                       A: *mut c_float);
    pub fn cblas_dsymv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_double,
                       A: *const c_double,
                       ...
                       y: *mut c_double,
                       incy: c_int);
    pub fn cblas_dsbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: c_double,
                       ...
                       y: *mut c_double,
                       incy: c_int);
    pub fn cblas_dspmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_double,
                       Ap: *const c_double,
                       ...
                       y: *mut c_double,
                       incy: c_int);
    pub fn cblas_dger(order: cblas::Order,
                      M: c_int,
                      N: c_int,
                      alpha: c_double,
                      x: *const c_double,
                      ...
                      A: *mut c_double,
                      lda: c_int);
    pub fn cblas_dsyr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: c_double,
                      x: *const c_double,
                      ...
                      A: *mut c_double,
                      lda: c_int);
    pub fn cblas_dspr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: c_double,
                      x: *const c_double,
                      incx: c_int,
                      Ap: *mut c_double);
    pub fn cblas_dsyr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_double,
                       x: *const c_double,
                       ...
                       A: *mut c_double,
                       lda: c_int);
    pub fn cblas_dspr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: c_double,
                       x: *const c_double,
                       ...
                       incy: c_int,
                       A: *mut c_double);
    pub fn cblas_chemv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       A: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_chbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_chpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       Ap: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_csymv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       A: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_csbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_cspmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       Ap: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_cgeru(order: cblas::Order,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_cgerc(order: cblas::Order,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_cher(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: *const c_void,
                      x: *const c_void,
                      ...
                      A: *mut c_void,
                      lda: c_int);
    pub fn cblas_chpr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: *const c_void,
                      x: *const c_void,
                      incx: c_int,
                      Ap: *mut c_void);
    pub fn cblas_cher2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_chpr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       incy: c_int,
                       Ap: *mut c_void);
    pub fn cblas_zhemv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       A: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zhbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zhpmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       Ap: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zsymv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       A: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zsbmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       K: c_int,
                       alpha: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zspmv(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       Ap: *const c_void,
                       ...
                       y: *mut c_void,
                       incy: c_int);
    pub fn cblas_zgeru(order: cblas::Order,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_zgerc(order: cblas::Order,
                       M: c_int,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_zher(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: *const c_void,
                      x: *const c_void,
                      ...
                      A: *mut c_void,
                      lda: c_int);
    pub fn cblas_zhpr(order: cblas::Order,
                      uplo: cblas::Uplo,
                      N: c_int,
                      alpha: *const c_void,
                      x: *const c_void,
                      incx: c_int,
                      Ap: *mut c_void);
    pub fn cblas_zher2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
                       ...
                       A: *mut c_void,
                       lda: c_int);
    pub fn cblas_zhpr2(order: cblas::Order,
                       uplo: cblas::Uplo,
                       N: c_int,
                       alpha: *const c_void,
                       x: *const c_void,
    ...
    pub fn cblas_sgemm(order: cblas::Order,
                       transA: cblas::Transpose,
                       ...
                       C: *mut c_float,
                       ldc: c_int);
    pub fn cblas_ssymm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_float,
                       ldc: c_int);
    pub fn cblas_ssyrk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       ...
                       C: *mut c_float,
                       ldc: c_int);
    pub fn cblas_ssyr2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
                        ...
                        C: *mut c_float,
                        ldc: c_int);
    pub fn cblas_strmm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_float,
                       ldb: c_int);
    pub fn cblas_strsm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_float,
                       ldb: c_int);
    pub fn cblas_dgemm(order: cblas::Order,
                       transA: cblas::Transpose,
                       transB: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_double,
                       ldc: c_int);
    pub fn cblas_dsymm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_double,
                       ldc: c_int);
    pub fn cblas_dsyrk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       trans: cblas::Transpose,
                       N: c_int,
                       K: c_int,
                       ...
                       C: *mut c_double,
                       ldc: c_int);
    pub fn cblas_dsyr2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
                        ...
                        C: *mut c_double,
                        ldc: c_int);
    pub fn cblas_dtrmm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_double,
                       ldb: c_int);
    pub fn cblas_dtrsm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_double,
                       ldb: c_int);
    pub fn cblas_cgemm(order: cblas::Order,
                       transA: cblas::Transpose,
                       transB: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_csymm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_csyrk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       trans: cblas::Transpose,
                       N: c_int,
                       K: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_csyr2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
                        ...
                        C: *mut c_void,
                        ldc: c_int);
    pub fn cblas_ctrmm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_void,
                       ldb: c_int);
    pub fn cblas_ctrsm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_void,
                       ldb: c_int);
    pub fn cblas_zgemm(order: cblas::Order,
                       transA: cblas::Transpose,
                       transB: cblas::Transpose,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_zsymm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_zsyrk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       trans: cblas::Transpose,
                       N: c_int,
                       K: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_zsyr2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
                        ...
                        C: *mut c_void,
                        ldc: c_int);
    pub fn cblas_ztrmm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_void,
                       ldb: c_int);
    pub fn cblas_ztrsm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       transA: cblas::Transpose,
                       diag: cblas::Diag,
                       ...
                       B: *mut c_void,
                       ldb: c_int);
    pub fn cblas_chemm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_cherk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       trans: cblas::Transpose,
                       N: c_int,
                       K: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_cher2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
                        ...
                        C: *mut c_void,
                        ldc: c_int);
    pub fn cblas_zhemm(order: cblas::Order,
                       side: cblas::Side,
                       uplo: cblas::Uplo,
                       M: c_int,
                       N: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_zherk(order: cblas::Order,
                       uplo: cblas::Uplo,
                       trans: cblas::Transpose,
                       N: c_int,
                       K: c_int,
                       ...
                       C: *mut c_void,
                       ldc: c_int);
    pub fn cblas_zher2k(order: cblas::Order,
                        uplo: cblas::Uplo,
                        trans: cblas::Transpose,
                        N: c_int,
                        K: c_int,
    ...
    pub fn gsl_blas_sdsdot(alpha: c_float,
    ...
    pub fn gsl_blas_srotg(a: *mut c_float,
                          b: *mut c_float,
                          c: *mut c_float,
                          d: *mut c_float)
                          -> enums::Value;
