...
/// This routine computes the sine function \sin(x).
pub fn sin_e(x: f64) -> (enums::Value, ::types::Result) {
...
/// This routine computes the cosine function \sin(x).
pub fn cos_e(x: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
/// This routine computes the hypotenuse function \sqrt{x^2 + y^2} avoiding overflow and underflow.
pub fn hypot_e(x: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
/// This routine computes \sinc(x) = \sin(\pi x) / (\pi x) for any value of x.
pub fn sinc_e(x: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn complex_sin_e(zr: f64, zi: f64) -> (enums::Value, ::types::Result, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn complex_cos_e(zr: f64, zi: f64) -> (enums::Value, ::types::Result, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
    let mut result2 = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn complex_logsin_e(zr: f64, zi: f64) -> (enums::Value, ::types::Result, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
    let mut result2 = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
/// This routine computes \log(\sinh(x)) for x > 0.
pub fn lnsinh_e(x: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
/// This routine computes \log(\cosh(x)) for x > 0.
pub fn lncosh_e(x: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn polar_to_rect(r: f64, theta: f64) -> (enums::Value, ::types::Result, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
    let mut result2 = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn rect_to_polar(x: f64, y: f64) -> (enums::Value, ::types::Result, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
    let mut result2 = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
pub fn sin_err_e(x: f64, dx: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
...
/// 
/// Note that this function is provided in the error-handling form only since its purpose is to compute the propagated error.
pub fn cos_err_e(x: f64, dx: f64) -> (enums::Value, ::types::Result) {
    let mut result = unsafe { zeroed::<::ffi::gsl_sf_result>() };
