...
/// This routine computes the lowest-order normalized hydrogenic bound state radial wavefunction R_1 := 2Z \sqrt{Z} \exp(-Z r).
pub fn hydrogenicR_1_e(Z: f64, r: f64) -> (enums::GslValue, ::types::Result) {
...
/// where L^a_b(x) is the generalized Laguerre polynomial (see [`Laguerre Functions`](http://www.gnu.org/software/gsl/manual/html_node/Laguerre-Functions.html#Laguerre-Functions)).
/// The normalization is chosen such that the wavefunction \psi is given by \psi(n,l,r) = R_n Y_{lm}.
pub fn hydrogenicR_e(n: i32, l: i32, Z: f64, r: f64) -> (enums::GslValue, ::types::Result) {
    let mut result = unsafe { zeroed::<ffi::gsl_sf_result>() };
...
pub fn wave_FG_e(eta: f64, x: f64, L_F: f64, k: i32, exp_F: &mut f64, exp_G: &mut f64) -> (enums::GslValue, ::types::Result, ::types::Result, ::types::Result, ::types::Result) {
...
pub fn wave_F_array(L_min: f64, eta: f64, x: f64, fc_array: &mut[f64], F_exponent: &mut f64) -> enums::GslValue {
...
pub fn wave_sphF_array(L_min: f64, eta: f64, x: f64, fc_array: &mut[f64], F_exponent: &mut f64) -> enums::GslValue {
...
pub fn CL_e(L: f64, eta: f64) -> (enums::GslValue, ::types::Result) {
    let mut result = unsafe { zeroed::<ffi::gsl_sf_result>() };
...
pub fn CL_array(Lmin: f64, eta: f64, cl: &mut [f64]) -> enums::GslValue {
