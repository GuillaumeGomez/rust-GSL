...
impl MathieuWorkspace {
    ...
    pub fn mathieu_a(n: i32, q: f64) -> Result<::types::Result, enums::Value> {
    ...
    /// This routine computes the characteristic values a_n(q), b_n(q) of the Mathieu functions ce_n(q,x) and se_n(q,x), respectively.
    pub fn mathieu_b(n: i32, q: f64) -> Result<::types::Result, enums::Value> {
        let mut result = unsafe { MaybeUninit::<sys::gsl_sf_result>::uninit() };
    ...
    pub fn mathieu_ce(n: i32, q: f64, x: f64) -> Result<::types::Result, enums::Value> {
        let mut result = unsafe { MaybeUninit::<sys::gsl_sf_result>::uninit() };
    ...
    /// This routine computes the angular Mathieu functions ce_n(q,x) and se_n(q,x), respectively.
    pub fn mathieu_se(n: i32, q: f64, x: f64) -> Result<::types::Result, enums::Value> {
        let mut result = unsafe { MaybeUninit::<sys::gsl_sf_result>::uninit() };
    ...
    pub fn mathieu_Mc(j: i32, n: i32, q: f64, x: f64) -> Result<::types::Result, enums::Value> {
        let mut result = unsafe { MaybeUninit::<sys::gsl_sf_result>::uninit() };
    ...
    ///
    /// The allowed values of j are 1 and 2. The functions for j = 3,4 can be computed as M_n^{(3)} = M_n^{(1)} + iM_n^{(2)} and M_n^{(4)} = M_n^{(1)} - iM_n^{(2)}, where M_n^{(j)} = Mc_n^{(j)} or Ms_n^{(j)}.
    pub fn mathieu_Ms(j: i32, n: i32, q: f64, x: f64) -> Result<::types::Result, enums::Value> {
        let mut result = unsafe { MaybeUninit::<sys::gsl_sf_result>::uninit() };
