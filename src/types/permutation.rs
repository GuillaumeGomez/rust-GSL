...
impl Permutation {
    ...
    pub fn copy(&self, dest: &mut Permutation) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_memcpy(dest.p, self.p) })
    }
    ...
    pub fn swap(&mut self, i: usize, j: usize) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_swap(self.p, i, j) })
    }
    ...
    pub fn inverse(&self, inv: &mut Permutation) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_inverse(inv.p, self.p) })
    }
    ...
    pub fn next(&mut self) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_next(self.p) })
    }
    ...
    pub fn prev(&mut self) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_prev(self.p) })
    }
    ...
    pub fn permute_vector(&mut self, v: &mut VectorF64) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permute_vector(self.p, ffi::FFI::unwrap_unique(v)) })
    }
    ...
    pub fn permute_vector_inverse(&self, v: &mut VectorF64) -> enums::Value {
        enums::Value::from(unsafe {
            ffi::gsl_permute_vector_inverse(self.p, ffi::FFI::unwrap_unique(v))
        })
    }
    ...
    pub fn mul(&mut self, pa: &Permutation, pb: &Permutation) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_mul(self.p, pa.p, pb.p) })
    }
    ...
    pub fn linear_to_canonical(&self, q: &mut Permutation) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_linear_to_canonical(q.p, self.p) })
    }
    ...
    pub fn canonical_to_linear(&self, p: &mut Permutation) -> enums::Value {
        enums::Value::from(unsafe { ffi::gsl_permutation_canonical_to_linear(p.p, self.p) })
    }
