...
impl $rust_name {
    ...
    pub fn copy_from(&mut self, other: &$rust_name) -> Result<(), Value> {
        let ret = unsafe { sys::[<$name _memcpy>](self.unwrap_unique(), other.unwrap_shared()) };
        result_handler!(ret, ())
    }
    ...
    pub fn swap(&mut self, other: &mut $rust_name) -> Result<(), Value> {
        let ret = unsafe { sys::[<$name _swap>](self.unwrap_unique(), other.unwrap_unique()) };
        result_handler!(ret, ())
    }

    /// This function copies the elements of the y-th row of the matrix into the returned vector.
    #[doc(alias = $name _get_row)]
    pub fn get_row(&self, y: usize) -> Result<$vec_name, Value> {
    ...
    pub fn set_row(&mut self, y: usize, v: &$vec_name) -> Result<(), Value> {
        let ret = unsafe { sys::[<$name _set_row>](self.unwrap_unique(), y, v.unwrap_shared()) };
        result_handler!(ret, ())
    }
    ...
    pub fn set_col(&mut self, x: usize, v: &$vec_name) -> Result<(), Value> {
        let ret = unsafe { sys::[<$name _set_col>](self.unwrap_unique(), x, v.unwrap_shared()) };
        result_handler!(ret, ())
    }
    ...
    pub fn transpose_memcpy(&self) -> Result<$rust_name, Value> {
        ...
        if dest.is_null() {
            ...
            result_handler!(ret, $rust_name::wrap(dest))
        }
    }
    ...
    pub fn add_diagonal(&mut self, x: $rust_ty) -> Result<(), Value> {
        let ret = unsafe { sys::[<$name _add_diagonal>](self.unwrap_unique(), x) };
        result_handler!(ret, ())
    }
