...
impl ffi::FFI<ffi::linalg::gsl_eigen_symm_workspace> for EigenSymmetricWorkspace {
    ...
    ) -> *mut ffi::linalg::gsl_eigen_symm_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_symmv_workspace> for EigenSymmetricVWorkspace {
    ...
    ) -> *const ffi::linalg::gsl_eigen_symmv_workspace {
        t.w as *const _
    }

    fn unwrap_unique(
        t: &mut EigenSymmetricVWorkspace,
    ) -> *mut ffi::linalg::gsl_eigen_symmv_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_herm_workspace> for EigenHermitianWorkspace {
    ...
    ) -> *mut ffi::linalg::gsl_eigen_herm_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_hermv_workspace> for EigenHermitianVWorkspace {
    ...
    ) -> *const ffi::linalg::gsl_eigen_hermv_workspace {
        t.w as *const _
    }

    fn unwrap_unique(
        t: &mut EigenHermitianVWorkspace,
    ) -> *mut ffi::linalg::gsl_eigen_hermv_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_nonsymm_workspace> for EigenNonSymmWorkspace {
    ...
    ) -> *mut ffi::linalg::gsl_eigen_nonsymm_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_nonsymmv_workspace> for EigenNonSymmVWorkspace {
    ...
    ) -> *const ffi::linalg::gsl_eigen_nonsymmv_workspace {
        t.w as *const _
    }

    fn unwrap_unique(
        t: &mut EigenNonSymmVWorkspace,
    ) -> *mut ffi::linalg::gsl_eigen_nonsymmv_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_gensymm_workspace> for EigenGenSymmWorkspace {
    ...
    ) -> *mut ffi::linalg::gsl_eigen_gensymm_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_gensymmv_workspace> for EigenGenSymmVWorkspace {
    ...
    ) -> *const ffi::linalg::gsl_eigen_gensymmv_workspace {
        t.w as *const _
    }

    fn unwrap_unique(
        t: &mut EigenGenSymmVWorkspace,
    ) -> *mut ffi::linalg::gsl_eigen_gensymmv_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_genherm_workspace> for EigenGenHermWorkspace {
    ...
    ) -> *mut ffi::linalg::gsl_eigen_genherm_workspace {
        t.w
    }
}
...
impl ffi::FFI<ffi::linalg::gsl_eigen_genhermv_workspace> for EigenGenHermVWorkspace {
    ...
    ) -> *const ffi::linalg::gsl_eigen_genhermv_workspace {
        t.w as *const _
    }

    fn unwrap_unique(
        t: &mut EigenGenHermVWorkspace,
    ) -> *mut ffi::linalg::gsl_eigen_genhermv_workspace {
        t.w
    }
}
